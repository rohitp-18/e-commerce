...
export const ORDER_DETAIL_REQUEST = "ORDER_DETAILS_REQUEST";
export const ORDER_DETAIL_SUCCESS = "ORDER_DETAILS_SUCCESS";
export const ORDER_DETAIL_FAIL = "ORDER_DETAILS_FAIL";
